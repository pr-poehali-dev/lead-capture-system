...
INTENT_KEYWORDS = [
    ...
    "единовременная выплата контракт", "подъёмные контракт", "300 тысяч контракт",
    "боевые выплаты", "денежное довольствие контракт", "льготы контрактникам",
    "как попасть в зону СВО", "хочу на СВО", "записаться добровольцем",
    "отряд добровольцев", "пункт отбора контракт", "военкомат контракт",
    "контракт с министерством обороны", "армия контракт 2024", "армия контракт 2025",
]

SEARCH_QUERIES = [
    "хочу заключить контракт с армией телефон",
    "служба по контракту записаться",
    "контракт МО условия выплаты",
    "пойти добровольцем СВО контакты",
    "единовременная выплата служба по контракту",
    "как записаться по контракту в армию",
    "контрактная служба подъёмные льготы",
    "хочу на СВО добровольцем как записаться",
    "пункт отбора контрактников телефон",
    "армия контракт 2025 выплаты условия",
    "контракт с минобороны",
    "срок контракта с минобороны",
    "пункт отбора на службу по контракту",
    "увольнение с военной службы по контракту",
    "служба по контракту бпла",
    "служба по контракту барс",
    "рубикон служба по контракту",
]
